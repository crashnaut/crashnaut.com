...
<Head title="Bits - Mike Sell" details={false} />

<svelte:head>
	<meta name="title" content={"Mike's Bits"} />
	<meta
		name="description"
		content={"Tools || (new) features || blog posts in a bit format on topics that I'm excited about."}
	/>

	<meta name="twitter:title" content={"Mike's Bits"} />
	<meta
		name="twitter:description"
		content={"Tools || (new) features || blog posts in a bit format on topics that I'm excited about."}
	/>

	<meta name="og:title" content={"Mike's Bits"} />
	<meta
		name="og:description"
		content={"Tools || (new) features || blog posts in a bit format on topics that I'm excited about."}
	/>
