...
4. **Comment Echo** — comments that restate the code instead of the _why_.
...
None is automatically a bug — each is worth a second look. Ask: _intentional, or a gap the AI filled?_
