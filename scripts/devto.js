...
(async () => {
	try {
		...
		const devToMarkdown = `
Follow me on Twitter at [@crashnaut](https://crashnaut.com/twitter) | Subscribe to the [Newsletter](https://crashnaut.com/newsletter) | Originally published on [crashnaut.com](${url}).
